...
import com.thezjh.digitalmall.dao.BrandMapper;
...
public class BrandServiceImpl implements BrandService {
    ...
    @Override
    public Integer insertProductBrand(ProductBrand productBrand) {
        return brandMapper.insertProductBrand(productBrand);
    }
}
